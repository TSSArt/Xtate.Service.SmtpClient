...
namespace TSSArt.StateMachine
{
	public class StateBuilder : IStateBuilder
	{
		...
		public void SetInitial(IReadOnlyList<IIdentifier> initialId) => _initialId = IdentifierList.Create(initialId ?? throw new ArgumentNullException(nameof(initialId)));

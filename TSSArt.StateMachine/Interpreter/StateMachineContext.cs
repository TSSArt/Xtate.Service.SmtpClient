...
namespace TSSArt.StateMachine
{
	internal class StateMachineContext : IStateMachineContext, IExecutionContext
	{
		...
		public ValueTask StartInvoke(string invokeId, Uri type, Uri source, DataModelValue content, DataModelValue parameters, CancellationToken token) =>
				_externalCommunication.StartInvoke(invokeId, type, source, content, parameters, token);
